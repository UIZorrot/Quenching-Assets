...
function InitBlizzard takes nothing returns nothing
    ...
    //call CinematicFilterGenericBJ( 0.00, BLEND_MODE_MODULATE_2X, "ReplaceableTextures\\CameraMasks\\White_mask.blp", 100, 100, 100, 0.00, 100.00, 100.00, 100.00, 0 )
    call SetSkyModel("environment\\sky\\genericsky\\genericsky.mdx")
    call SetTerrainFogEx(0,1000,7000,1,0.55,0.6,0.65)  
endfunction
